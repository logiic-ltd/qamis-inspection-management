...
def search_users(search_term):
    ...
    try:
        url = f"http://192.168.1.65:8081/api/dhis2users/search/name?name={search_term}&page=0&size=20&sort=username,asc"
...
def search_checklists(search_term):
    ...
    url = f"http://192.168.1.65:8081/api/dhis2datasets/search/name?name={search_term}&page=0&size=20&sort=name,asc"
...
def search_schools(search_term):
    ...
    url = f"http://192.168.1.65:8081/api/schools/search?name={search_term}&page=0&size=20&sort=schoolName,asc"
